...
#	rm family-unclassified_V*.fasta
	...
	#truncate the reads to minimum length determined from benchmark on OTU clustering for input reads with variable read length

	#V1V3-reverse: minimum length selected is 300 bp
	/home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_revcomp family-unclassified_V1V3.fa --fastaout family-unclassified_V1V3_reverse-complement.fa --threads $THREADS

	/home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_filter family-unclassified_V1V3_reverse-complement.fa \
								  --fastaout family-unclassified_V1V3_reverse-complement_MinLen.fa --fastq_trunclen 300 --threads $THREADS

	/home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_revcomp family-unclassified_V1V3_reverse-complement_MinLen.fa \
								  --fastaout family-unclassified_MinLen_V1V3_reverse.fa --threads $THREADS

        #V3V5: minimum length selected is 300 bp
        /home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_revcomp family-unclassified_V3V5.fa --fastaout family-unclassified_V3V5_reverse-complement.fa --threads $THREADS

        /home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_filter family-unclassified_V3V5_reverse-complement.fa \
                                                                  --fastaout family-unclassified_V3V5_reverse-complement_MinLen.fa --fastq_trunclen 300 --threads $THREADS

        /home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_revcomp family-unclassified_V3V5_reverse-complement_MinLen.fa \
                                                                  --fastaout family-unclassified_MinLen_V3V5_reverse.fa --threads $THREADS

        #V4: minimum length selected is 200 bp
        /home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_revcomp family-unclassified_V4.fa --fastaout family-unclassified_V4_reverse-complement.fa --threads $THREADS

        /home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_filter family-unclassified_V4_reverse-complement.fa \
                                                                  --fastaout family-unclassified_V4_reverse-complement_MinLen.fa --fastq_trunclen 200 --threads $THREADS

        /home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_revcomp family-unclassified_V4_reverse-complement_MinLen.fa \
                                                                  --fastaout family-unclassified_MinLen_V4_reverse.fa --threads $THREADS

        #V6V9: minimum length selected is 300 bp
        /home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_revcomp family-unclassified_V6V9.fa --fastaout family-unclassified_V6V9_reverse-complement.fa --threads $THREADS

        /home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_filter family-unclassified_V6V9_reverse-complement.fa \
                                                                  --fastaout family-unclassified_V6V9_reverse-complement_MinLen.fa --fastq_trunclen 300 --threads $THREADS

        /home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_revcomp family-unclassified_V6V9_reverse-complement_MinLen.fa \
                                                                  --fastaout family-unclassified_MinLen_V6V9_reverse.fa --threads $THREADS

	rm *reverse-complement*

	#taxonomic annotation
	for AmpliconFile in $PWD/family-unclassified_MinLen_V*_reverse.fa
	do
		...
		cp $AmpliconFile ./
		python /home/qinglong/softwares/BLCA-python3/2.blca_main.py -i family-unclassified_MinLen_V*.fa \
	...
	for BLCAout in $PWD/*MinLen_*_reverse_BLCA_out_identity*_cov*.txt
	do
	...
	echo -e "Accession\tUnclassified\tClassified\tTotalCount" | cat - temp > 'Iteration_'$iteration'_overclassification_summary_MinLen_revise.txt'
	rm temp
