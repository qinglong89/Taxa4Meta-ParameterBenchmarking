...
#	rm family-unclassified_V*.fasta
	...
	#V1V3: minimum length selected is 200 bp
	/home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_filter family-unclassified_V1V3.fa --fastaout family-unclassified_MinLen_V1V3.fa --fastq_trunclen 200 --threads $THREADS
        #V1V3: minimum length selected is 250 bp
        /home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_filter family-unclassified_V3V5.fa --fastaout family-unclassified_MinLen_V3V5.fa --fastq_trunclen 250 --threads $THREADS
        #V4: minimum length selected is 200 bp
        /home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_filter family-unclassified_V4.fa --fastaout family-unclassified_MinLen_V4.fa --fastq_trunclen 200 --threads $THREADS
        #V6V9: minimum length selected is 300 bp
        /home/qinglong/softwares/vsearch-binary-2.9.0/bin/vsearch --fastx_filter family-unclassified_V6V9.fa --fastaout family-unclassified_MinLen_V6V9.fa --fastq_trunclen 300 --threads $THREADS


	#taxonomic annotation
	for AmpliconFile in $PWD/family-unclassified_MinLen_V*.fa
	do
	...
	for BLCAout in $PWD/*MinLen_*_BLCA_out_identity*_cov*.txt
	do
	...
	echo -e "Accession\tUnclassified\tClassified\tTotalCount" | cat - temp > 'Iteration_'$iteration'_overclassification_summary_MinLen.txt'
	rm temp
